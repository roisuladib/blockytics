...
export const Flash = ({ fill = 'currentColor', size, height, width, ...props }: IconSvgProps) => {
   return (
      <svg
         fill="none"
         height={size || height}
...
export const Server = ({ fill = 'currentColor', size, height, width, ...props }: IconSvgProps) => {
   return (
      <svg
         fill="none"
         height={size || height}
...
export const TagUser = ({ fill = 'currentColor', size, height, width, ...props }: IconSvgProps) => {
   return (
      <svg
         fill="none"
         height={size || height}
...
export const Scale = ({ fill = 'currentColor', size, height, width, ...props }: IconSvgProps) => {
   return (
      <svg
         fill="none"
         height={size || height}
