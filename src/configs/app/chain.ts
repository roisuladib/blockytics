...
import type { RollupType } from '^types/client';
...
const verificationType: NetworkVerificationType = (() => {
   ...
   return (
      (getEnvValue('NEXT_PUBLIC_NETWORK_VERIFICATION_TYPE') as NetworkVerificationTypeEnvs) ||
      'mining'
   );
})();
...
const chain = Object.freeze({
   ...
   currency: {
      ...
      decimals:
         Number(getEnvValue('NEXT_PUBLIC_NETWORK_CURRENCY_DECIMALS')) || DEFAULT_CURRENCY_DECIMALS,
   },
   secondaryCoin: {
