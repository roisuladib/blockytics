...
export interface ApiQueryParams<R extends ResourceName, E = unknown, D = ResourcePayload<R>> {
   ...
   queryOptions?: Partial<
      Omit<UseQueryOptions<ResourcePayload<R>, ResourceError<E>, D>, 'queryFn'>
   >;
}
...
export default function useApiQuery<R extends ResourceName, E = unknown, D = ResourcePayload<R>>(
   resource: R,
   { queryOptions, pathParams, queryParams, fetchParams }: ApiQueryParams<R, E, D> = {},
) {
